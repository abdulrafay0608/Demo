...
const TicketAdd = () => {
  ...
  const onJoditChange = (content) => {
    setJoditContent(content);
  };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="">
          <div className="flex gap-x-6 p-6">
              ...
              <div className="flex gap-x-6 w-full">
                <div className="w-1/2">
                  <Input
                    ...
                    isRequired={true}
                    className="md:px-4 px-2 py-2 cursor-not-allowed"
                  />
                </div>
                <div className="w-1/2">
                  <Input
            ...
            <div className="w-1/2">
              <Select
                label={
                  <>
                    <FaTag size={14} className="mr-1 text-gray-700 text-xl" />{" "}
                    Tag
                  </>
                }
                name="tag"
              ...
              <Select
                ...
                {...register("assign_ticket", {
                  required: "Assign ticket is required",
                })}
          ...
          <div className="flex gap-x-6 w-full p-6">
            ...
            <div className="w-1/2">
              <Select
                label={
                  <>
                    <span className="invisible">Ticket Body</span>
                  </>
                }
                name="knowledge"
                options={countries.map((country) => ({
                ...
                {...register("knowledge", {
                  required: "Insert knowledge base link is required",
                })}
                error={errors.tag?.message}
                value={selectedCountry}
                onChange={(value) => setSelectedCountry(value)}
          ...
          <div className="flex gap-x-6 w-full p-6">
            {/* <ReactQuill
              ...
              placeholder="Write your Quill editor content..."
              modules={{
                toolbar: [
                  [{ header: [1, 2, false] }],
            ...
            <JoditEditor
              ...
              onBlur={(newContent) => onJoditChange(newContent)} // Updates on blur
              config={{
                readonly: false,
                height: 300,
                placeholder: "Write your Jodit editor content...",
              }}
            />
            {errors.ticket_body?.message && (
